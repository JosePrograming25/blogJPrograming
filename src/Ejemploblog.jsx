import { aLink, article, dtitleArt, titleArticle, pArticle, subArticle, img } from './styles/element_basic'
import CodeSnippet from './components/CodeSnippet'
import ejemplo1 from './images/imge_ejemplo.jpg'
import ejemplo2 from './images/ejemplo2.avif'
  ...
  return (
    <div className={article()}>
      ...
      <div className='contArticle'>
        ...
        <img src={ejemplo1} alt='ejemplo1' className={img()} />
        ...
        <img src={ejemplo2} alt='ejemplo2' className={img()} />
